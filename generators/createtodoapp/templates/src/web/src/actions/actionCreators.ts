...
export function createPayloadAction<TAction extends PayloadAction<TAction['type'], TAction['payload']>>(
  type: TAction['type'],
): (payload: TAction['payload']) => PayloadAction<TAction['type'], TAction['payload']> {
...
export function bindActionCreators(
  ...
  if (typeof actionCreators !== 'object' || actionCreators === null) {
    throw new Error(
      'bindActionCreators expected an object or a function, did you write "import ActionCreators from" instead of "import * as ActionCreators from"?',
    );
  }
